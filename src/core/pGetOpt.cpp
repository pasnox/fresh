...
** Authors   : Filipe Azevedo aka Nox P@sNox <pasnox@gmail.com> & Copyrighted authors later defined
** Project   : Fresh Library
** FileName  : pGetOpt.cpp
...
/**
    ...
    of your program. The name \em pGetOpt is based on similar utilities
...
/**
    \internal
*/
bool pGetOpt::parse( bool untilFirstSwitchOnly )
{
...
/**
    \internal
*/
void pGetOpt::addOption( Option o )
{
    // ### check for conflicts
    options.append( o );
}
...
*/
void pGetOpt::addSwitch( const QString &lname, bool *b )
{
...
/**
    \internal
*/
void pGetOpt::setSwitch( const Option &o )
{
...
*/
void pGetOpt::addOption( char s, const QString &l, QString *v )
{
...
/**
    ...
    \endcode
    */
void pGetOpt::addVarLengthOption( const QString &l, QStringList *v )
{
...
/**
    ...
    \endcode
    */
void pGetOpt::addRepeatableOption( char s, QStringList *v )
{
...
/**
    ...
    */
void pGetOpt::addRepeatableOption( const QString &l, QStringList *v )
{
...
/**
    ...
    \sa addOption
    */
void pGetOpt::addOptionalOption( const QString &l, QString *v, const QString &def )
{
...
/**
    ...
    the value is not specified by the user it will be set to \a def.
    */
void pGetOpt::addOptionalOption( char s, const QString &l, QString *v, const QString &def )
{
    Option opt( OOpt, s, l );
    opt.stringValue = v;
    opt.def = def;
...
/**
    ...
    isSet() function.
    */
void pGetOpt::addArgument( const QString &name, QString *v )
{
...
/**
    ...
    */
void pGetOpt::addOptionalArgument( const QString &name, QString *v )
{
    Option opt( OUnknown, 0, name );
    opt.stringValue = v;
    optArg = opt;
...
bool pGetOpt::isSet( const QString &name ) const
{
    return setOptions.find( name ) != setOptions.end();
}

/**
    \fn int pGetOpt::currentArgument() const
    \internal
*/
